    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen bg-[#1c1410] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold text-white leading-none mb-6">
            Manufactura
            <br />
            <span className="text-[var(--accent)]">Artesanal</span>
            <br />
            de Alto Diseño
          </h1>

          <p className="text-xl text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed">
            Fusionamos <strong className="text-white">6 técnicas ancestrales</strong> en piezas únicas e irrepetibles para tu espacio. Cada obra es una historia que dura generaciones.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
            {[
              { num: "6+", label: "Técnicas" },
              { num: "200+", label: "Proyectos" },
              { num: "100%", label: "Artesanal" },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-3xl font-bold text-[var(--accent)]">{stat.num}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[var(--foreground)] mb-4">
              6 Técnicas Ancestrales,
              <br />
              <span className="text-[var(--accent)]">1 Maestro Artesano</span>
            </h2>
            <p className="text-[var(--muted-foreground)] max-w-2xl mx-auto text-lg">
              No subcontratamos. Cada pieza se crea completamente en nuestro taller, combinando técnicas que normalmente requerirían 5 artesanos diferentes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {TECHNIQUES.map((tec) => (
              <div
                key={tec.id}
                className="group p-6 bg-white rounded-xl border border-[var(--border)] hover:border-[var(--accent)] hover:shadow-lg transition-all duration-300 text-center cursor-default"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                Piezas que son imposibles de replicar industrialmente
              </h2>
              <p className="text-white/60 text-lg leading-relaxed mb-8">
                El resultado de combinar carpintería, soldadura, resina epóxica, vitrales, cerámica y construcción antisísmica en un solo taller: muebles y objetos únicos con alma propia.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={feature.title}
                  className="p-5 bg-white/5 rounded-xl border border-white/10 hover:border-[var(--accent)]/50 transition-colors"
                >
                  <div className="text-[var(--accent)] mb-3">{feature.icon}</div>
                  <div className="font-semibold text-white mb-1">{feature.title}</div>
                  <div className="text-white/50 text-sm leading-relaxed">{feature.desc}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--muted-foreground)] text-lg">
              Explora nuestras 6 categorías de productos artesanales
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {CATEGORIES.map((cat) => (
              <Link
                ...
                className="group relative p-8 bg-white rounded-2xl border border-[var(--border)] hover:border-[var(--accent)] hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
      ...
      <section className="py-24 bg-[var(--muted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SAMPLE_PRODUCTS.filter((p) => p.is_featured || true).slice(0, 4).map((product) => (
              <Link
                key={product.id}
                href={`/producto/${product.slug}`}
                className="group bg-white rounded-xl overflow-hidden border border-[var(--border)] hover:shadow-xl transition-all duration-300"
              >
                {/* Image placeholder */}
                <div className="aspect-square bg-gradient-to-br from-[#5c3d1e]/10 to-[var(--accent)]/10 relative overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    {product.is_featured && (
                      <span className="bg-[var(--accent)] text-[var(--accent-foreground)] text-xs font-semibold px-2 py-1 rounded-full">
                        Destacado
                      </span>
                    )}
                  </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[var(--foreground)] mb-4">
              Del Concepto a tu Espacio
            </h2>
            <p className="text-[var(--muted-foreground)] text-lg">
              5 pasos para crear tu pieza artesanal perfecta
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              { num: "01", title: "Consulta", desc: "Cuéntanos tu idea, medidas y presupuesto" },
            ...
            {[
              {
                ...
                text: "La mesa de río que hicieron para mi proyecto superó todas las expectativas. La combinación de madera y resina es impresionante. Mis clientes quedaron fascinados.",
                stars: 5,
              },
              {
                name: "Carlos Vega",
                role: "Restaurant El Marqués, La Serena",
                text: "Encargamos 8 mesas industriales y las lámparas de vitral para nuestro restaurant. El resultado es increíble, le dio una identidad única al local. Totalmente recomendado.",
                stars: 5,
              },
              {
                name: "Ana Morales",
                role: "Propietaria, Ovalle",
                text: "Mi puerta con vitral es la envidia del barrio. La atención personalizada y la calidad del trabajo son excepcionales. Ya estamos planificando la cocina completa.",
                stars: 5,
              },
            ].map((testimonial) => (
              <div
                key={testimonial.name}
                className="bg-white p-8 rounded-2xl border border-[var(--border)] shadow-sm"
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-[var(--foreground)] text-sm">{testimonial.name}</div>
                    <div className="text-xs text-[var(--muted-foreground)]">{testimonial.role}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-24 bg-[var(--primary)] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-10">
            Cuéntanos tu idea. Hacemos realidad piezas únicas que ninguna fábrica puede replicar.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href={`https://wa.me/56912345678?text=Hola! Tengo un proyecto que me gustaría cotizar.`}
              target="_blank"
